...
import type { DeploySettings, GitConnection, ListResponse, Me, NotificationTarget, Passkey, UpdateStatus } from "@/lib/types";
  ...
  return (
    <>
      ...
      <p className="subtle" style={{ marginTop: -6, marginBottom: 12 }}>
        ...
        If Connect asks for OAuth app details, an admin can enter them in the modal.
      </p>
